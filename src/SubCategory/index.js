...
const SubCategory = ({Data:{name, horizontalCoordinates},chosenSubCategory , subCategoryHover, onChoseSubCategory, onHover, unHover}) => (
  <div
    className={
  ...
  >
    <img style={{paddingRight: '4px'}} width="20" height="20" src={placeholder} alt="placeholder" />
    {name}
  </div>
)
