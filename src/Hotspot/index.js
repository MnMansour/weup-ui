...
const Hotspot = ({ data:{name, screenCoordinates}, chosenSubCategory, subCategoryHover, onChoseSubCategory, onHover, unHover, rotateDone}) => (
  <div  className={classNames(
    ...
    <div
      ...
      onClick={()=> onChoseSubCategory(name)}
